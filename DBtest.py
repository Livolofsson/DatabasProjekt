...
mycursor.execute("INSERT IGNORE INTO Product VALUES(1, 'Dress', 'Short blue dress', 100, 10, 20, 1000, 1, 3)")
mycursor.execute("INSERT IGNORE INTO Product VALUES(2, 'Jeans', 'Stretchy blue jeans', 99.90, 15.99, 0, 500, 1, 3)")
mycursor.execute("INSERT IGNORE INTO Product VALUES(3, 'Cardigan', 'Soft pink wool cardigan', 200, 19.90, 0, 100, 1, 3)")

mycursor.execute("INSERT IGNORE INTO Product VALUES(4, 'Jeans', 'Black jeans', 500, 10, 0, 50, 1, 4)")
mycursor.execute("INSERT IGNORE INTO Product VALUES(5, 'Shirt', 'Red cotton shirt', 1000, 50, 0, 0, 0, 4)")
mycursor.execute("INSERT IGNORE INTO Product VALUES(6, 'Shorts', 'Green and yellow cotton shorts', 600, 50, 60, 100, 1, 4)")

mycursor.execute("INSERT IGNORE INTO Product VALUES(7, 'Jeans', 'White jeans', 400, 40, 0, 50, 0, 5)")
mycursor.execute("INSERT IGNORE INTO Product VALUES(8, 'Skirt', 'Red skirt dotted in white', 300, 30, 0, 100, 0, 5)")

mycursor.execute("INSERT IGNORE INTO Product VALUES(9, 'Daycream', 'Daycream for oily skin', 150, 15, 0, 100, 1, 7)")
mycursor.execute("INSERT IGNORE INTO Product VALUES(10, 'Peeling', 'Peeling to help with dry skin', 100, 10, 0, 50, 0, 7)")

mycursor.execute("INSERT IGNORE INTO Product VALUES(11, 'Shower gel', 'Shower gel with shea butter', 150, 15, 50, 20, 1, 8)")
mycursor.execute("INSERT IGNORE INTO Product VALUES(12, 'Body lotion', 'Body lotion for everyday use', 400, 40, 0, 60, 0, 8)")

mycursor.execute("INSERT IGNORE INTO Product VALUES(13, 'Sun screen', 'Sun screen for everyday use', 100, 10, 0, 30, 1, 9)")

#users 
mycursor.execute("INSERT IGNORE INTO User VALUES('650105-1122', 'Saga Andersson', '0722336776', 'saga_andersson@outlook.com', 'Bergsvägen 3 47887 Uppsala', '4g4s4nd3rsson', 1)")
mycursor.execute("INSERT IGNORE INTO User VALUES('750210-4444', 'Bert Gustavsson', '0738439988', 'bert_gustavsson@outlook.com', 'Kroksgatan 10 99577 Stockholm', 'b3rtgust4vss0n', 0)")

#reviews
mycursor.execute("INSERT IGNORE INTO Review VALUES ('650105-1122', 1, 'I looove this dress. It is so soft and I use it several times a week! Best dress ever!!!', 5, '2024-10-02')")
mycursor.execute("INSERT IGNORE INTO Review VALUES ('750210-4444', 1, 'I did not like this dress at all!! It was way too tiny. I had too wide shoulders to fit, not a good dress for a big strong man!', 5, '2024-10-02')")

#order
mycursor.execute("INSERT IGNORE INTO OrderUser VALUES (1, '2024-10-02', '2024-10-02', 'PAY12345', 123456, 1, '650105-1122')")
